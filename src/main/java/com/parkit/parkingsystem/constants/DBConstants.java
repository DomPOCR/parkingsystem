...
public class DBConstants {
	...
	// OLD : public static final String GET_TICKET = "select t.PARKING_NUMBER,
	// t.ID, t.PRICE, t.IN_TIME, t.OUT_TIME, p.TYPE from ticket t,parking p
	// where p.parking_number = t.parking_number and t.VEHICLE_REG_NUMBER=?
	// order by t.IN_TIME limit 1";
	// NEW : ajout d'un tri descendant
